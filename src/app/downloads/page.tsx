    ...
    <div className="mx-auto flex min-h-[calc(100vh-64px)] max-w-6xl flex-col px-6 py-16">
      ...
      <div className="mb-12 flex flex-col items-center gap-3 text-center">
        ...
        {release ? (
          ...
          <p className="text-[var(--muted)]">
            Get PristineCleaner for your platform.
          </p>
        )}
      </div>
      ...
      {release ? (
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {release.assets.map((asset) => (
                      <tr
                        key={asset.name}
                        className="border-b border-[var(--border)] last:border-0 bg-[var(--background)] hover:bg-[var(--surface)] transition-colors"
                      >
        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-6 text-center">
          <div className="flex h-20 w-20 items-center justify-center rounded-2xl border border-dashed border-[var(--border)] bg-[var(--surface)]">
            <svg
              width="36"
              height="36"
              viewBox="0 0 24 24"
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="max-w-md text-[var(--muted)]">
              The first release hasn&apos;t been published yet. Check back soon,
              or watch the repository on GitHub to be notified.
            </p>
          </div>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 rounded-lg border border-[var(--border)] bg-[var(--surface)] px-5 py-2.5 text-sm font-medium text-[var(--foreground)] transition-colors hover:border-[var(--accent)] hover:text-[var(--accent)]"
          >
            <svg
              width="16"
              height="16"
